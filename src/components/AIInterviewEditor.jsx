...
function AIInterviewEditor({ interviewData: initialData, applicationType, onClose, onSave }) {
  ...
  const updateFieldLabel = (sectionIndex, questionIndex, fieldIndex, label) => {
    setInterviewData(prev => {
      const newSections = [...prev.sections];
      newSections[sectionIndex].questions[questionIndex].fields[fieldIndex] = {
        ...newSections[sectionIndex].questions[questionIndex].fields[fieldIndex],
        label
      };
      return { ...prev, sections: newSections };
  ...
  const updateFieldType = (sectionIndex, questionIndex, fieldIndex, type) => {
    setInterviewData(prev => {
      const newSections = [...prev.sections];
      const field = newSections[sectionIndex].questions[questionIndex].fields[fieldIndex];
  ...
  const deleteField = (sectionIndex, questionIndex, fieldIndex) => {
    setInterviewData(prev => {
      const newSections = [...prev.sections];
      newSections[sectionIndex].questions[questionIndex].fields = 
        newSections[sectionIndex].questions[questionIndex].fields.filter((_, i) => i !== fieldIndex);
      return { ...prev, sections: newSections };
    });
    setHasChanges(true);
  };
  ...
  const addField = (sectionIndex, questionIndex) => {
    setInterviewData(prev => {
      const newSections = [...prev.sections];
      newSections[sectionIndex].questions[questionIndex].fields.push({
